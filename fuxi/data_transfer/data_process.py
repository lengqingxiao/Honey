...
class ProcessDataForJD(object):
    ...
    def process_order_data(self):
        ...
        self.jd_order_info['if_order_use_jd_shop'] = \
            self.jd_order_info['title'].apply(CheckDataForJD.check_order_goods_type_config(USER_FOR_CHECK_JD_SHOP))
        self.jd_order_info['if_order_use_jd_send'] = \
            self.jd_order_info['title'].apply(CheckDataForJD.check_order_goods_type_config(USER_FOR_CHECK_JD_SEND))
