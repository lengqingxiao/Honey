...
import pandas as pd
from data_transfer.data_connect import ConnectMongodb, ConnectMysql
...
class QueryData(object):
    ...
    @staticmethod
    def query_data_from_mongodb_func(db_path, port, db_name, table_name, check_list, unique_id_col, unique_id_value):
        """
        mongodb conditional query
        return : result list
