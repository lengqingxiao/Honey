...
奢饰品 (各类别奢饰品）
"""
LUXURY = pd.read_csv('D:/jd_luxury_all.csv', encoding='gbk')
# print(LUXURY)
USE_FOR_CHECK_LUXURY = tuple(list(LUXURY['goods_names']))
# USE_FOR_CHECK_LUXURY = (
#     u'奢饰品', u'奢饰', u'香奈儿', u'CHANEL', u'路易.威登', u'LV', u'迪奥', u'Dior', u'范思哲', u'Versace',
#     u'古琦欧.古琦',  u'Gucci', u'阿玛尼', u'Armani', u'瓦伦蒂诺', u'Valentino', u'普拉达', u'prada', u'巴宝莉',
#     u'Burberry', u'杰尼亚', u'Zeqna', u'雅诗兰黛', u'兰蔻', u'倩碧', u'迪奥', u'香奈儿', u'Berj Al-Arab', u'伯瓷',
#     u'Fendi', u'芬迪', u'Piaget', u'伯爵', u'Patek Philippe', u'百达翡丽', u'Riva' , u'丽娃', u'Azimut', u'阿兹慕',
#     u'Bvlgari', u'宝格丽', u'MontBlance', u'万宝龙', u'杜嘉班纳', u'Boucheron', u'宝诗龙', u'GiorgioArmani', u'阿玛尼',
#     u'ElizabethArden', u'雅顿', u'Loewe', u'罗意威', u'LANCOME', u'Dunhill', u'登喜路', u'路易威登', u'爱马仕',
#     u'Hermes', u'茅台', u'五粮液', u'古驰', u'劳力士', u'Rolex', u'卡地亚', u'Cartier', u'轩尼诗', u'Hennessy',
#     u'蒂芙尼', u'Tiffany', u'酩悦', u'MOET&CHANDON', u'华伦天奴', u'Valentino', u'波士', u'Hugoboss', u'纪梵希',
#     u'Givenchy', u'百加得', u'Bacardi', u'梵克雅宝', u'VanCleef', u'伊夫圣罗兰', u'绝对伏特加', u'Absolut', u'尊尼获加',
#     u'JohnnieWailer', u'唐纳·卡兰', u'Louis Vuitton', u'Chanel', u'范思哲', u'Dior', u'古驰', u'瓦伦蒂诺·加拉瓦尼',
#     u'PRADA', u'GUESS', u'乔治·阿玛尼', u'卡地亚、蒂芬尼', u'ENZO', u'Oxette', u'宝诗龙', u'Bulgari', u'御木本',
#     u'Graff', u'Georgjensen', u'波米雷特', u'百达翡丽', u'爱彼', u'伯爵', u'江诗丹顿', u'卡地亚', u'劳力士', u'积家',
#     u'IWC', u'万国', u'芝柏', u'欧米茄', u'娇兰', u'娇韵诗', u'伊丽莎白·雅顿', u'奥伦纳素', u'奥克利', u'珠迪丝·雷伯',
#     u'唐那·凯伦', u'圣罗兰', u'唐纳·卡兰', u'路易·威登', u'夏奈尔', u'帕克', u'威尔·永锋', u'华特曼', u'卡地亚',
#     u'犀飞利', u'奥罗拉', u'高仕', u'Montegrappa', u'高斯巴', u'阿波罗', u'大卫杜夫', u'圣罗兰', u'丹纳曼', u'颐年世纪',
#     u'宾治', u'百得佳士'
#
#
# ) + tuple(list(LUXURY['goods_names'])) + tuple(list(LUXURY['goods_name_e']))
#
# print(USE_FOR_CHECK_LUXURY)
"""
家电清单
"""
...
#     result_df['if_%s' % _k] = pd.Series(list(set(_v)))
# print(result_df)
